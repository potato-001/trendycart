...
const Card = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-around' style={{backgroundColor:'pink',padding:"15px"}}>
      <>
      ...
      <div className="credit-card-info--form">
        ...
        <div className="input_container">
          ...
          <input
            ...
            type="number"
            className="input_field"
            id="password_field" style={{border:"1px solid #ccc"}}
          />
        </div>
        <div className="input_container">
          <label className="input_label" htmlFor="password_field">
          ...
          <div className="split">
            ...
            <input
              ...
              className="input_field"
              id="password_field"
              style={{border:"1px solid #ccc", marginTop:"6px"}} />
          </div>
        </div>
